...
hiddenimports = [
    ...
    "orchestrator.tools.native.system_info",
    "orchestrator.tools.native.processes",
    "orchestrator.tools.native.media_control",
    "orchestrator.tools.native.media_library",
    "orchestrator.tools.native.media_player",
    "orchestrator.tools.native.media_playlist",
    "orchestrator.tools.native.web_fetch",
    "orchestrator.tools.native.web_search",
    "orchestrator.tools.native.web_scrape",
    "orchestrator.tools.native.web_news",
    "orchestrator.tools.native.web_youtube",
    "orchestrator.tools.native.web_wikipedia",
    "orchestrator.tools.native.web_arxiv",
    "orchestrator.tools.native.webreddit",
    "orchestrator.tools.native.webgithub",
    "orchestrator.tools.native.webstackexchange",
    "orchestrator.tools.native.web_hackernews",
    "orchestrator.tools.native.web_producthunt",
    "orchestrator.tools.native.web_pubmed",
    "orchestrator.tools.native.web_sec",
    "orchestrator.tools.native.web_misc",
    "orchestrator.tools.native.files",
    "orchestrator.tools.native.calendar",
    "orchestrator.tools.native.email_tool",
    "orchestrator.tools.native.image_gen",
    "orchestrator.tools.native.screenshot",
    "orchestrator.tools.native.screen_recorder",
    "orchestrator.tools.native.notes",
    "orchestrator.tools.native.reminders",
    "orchestrator.tools.native.timer",
    "orchestrator.tools.native.weather",
    "orchestrator.tools.native.news",
    "orchestrator.tools.native.finance",
    "orchestrator.tools.native.translate",
    "orchestrator.tools.native.code_interpreter",
    "orchestrator.tools.native.smart_solver",
    "orchestrator.tools.native.knowledge_base",
    "orchestrator.tools.native.booking",
    "orchestrator.tools.native.shopping",
    "orchestrator.tools.native.device_control",
    "orchestrator.tools.native.suno_music",
    "orchestrator.tools.native.upstox",
    "orchestrator.tools.native.maps",
    "orchestrator.tools.native.health",
    "orchestrator.tools.native.recipe",
    "orchestrator.tools.native.vision",
    "orchestrator.tools.native.memory_search",
    "orchestrator.tools.native.memory_save",
    "orchestrator.tools.native.memory_list",
    "orchestrator.tools.native.memory_delete",
    "orchestrator.tools.native.memory_backup",
    "orchestrator.tools.native.memory_restore",

    # ── Tool router module ──
    "orchestrator.tools.router",
